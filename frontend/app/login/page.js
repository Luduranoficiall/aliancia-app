export default function Login() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-aliancia-black">
      <h1 className="text-4xl font-bold text-aliancia-blue mb-4">Login</h1>
      <form className="flex flex-col gap-4 w-full max-w-xs">
        ...
        <button type="submit" className="px-6 py-2 bg-aliancia-blue text-black rounded-lg font-semibold hover:bg-blue-400 transition">Entrar</button>
      </form>
      <a href="/cadastro" className="mt-4 text-aliancia-blue underline">Criar conta</a>
    </main>
  );
}